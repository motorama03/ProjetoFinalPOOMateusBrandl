...
public class MainVeiculoNovo {
	...
	// Alteração por modelo (para mudar o preço, marca etc)
		...
		VeiculoNovo veiculoNovo = new VeiculoNovo("Fiat", "Touro", 120000, 12);
	...
	// Exclusão de veiculo via modelo
		...
		VeiculoNovo veiculoNovoEx = new VeiculoNovo("Touro");
	...
	// Inserção de veiculos Novos
		...
		VeiculoNovo veiculoNovoNew = new VeiculoNovo("Fiat", "Touro", 120000, 10);
	...
	// Venda de veiculos (diminui a quantidade de veicuos do banco (1 por vez))
		...
		VeiculoNovo veiculoNovoAltIdVendas = new VeiculoNovo("Touro");
